  ...
  return (
    <div className="w-full h-dvh relative z-95 home">
      <img
        ...
        className="size-full absolute top-0 left-0 z-96 opacity-0.0099"
      />
      <div className="pt-[15vh] size-full z-96 relative flex justify-center items-center flex-col home1">
        ...
        <p className="text-white text-[1.4vw] px-[20vw] text-center font-semibold home12 text-shadow-black">
        ...
        <div className="flex gap-[3vw] mt-[3vw] home13">
          <button className="py-[0.8vw] px-[3vw] bg-[#6bffffa2] flex items-center gap-[1vw] font-semibold rounded-lg text-[#ffffffd0] hover:scale-97 hover:bg-amber-300 border-2 transition-all duration-300 ease-linear cursor-pointer">
            <IoIosWarning className="text-[2vw] i" />
            Report Incident
          </button>
          <button className="border-2 rounded-lg py-[0.8vw] px-[3vw] flex items-center gap-[1vw] font-semibold text-[#ffffffd0] hover:bg-amber-300 hover:scale-97 transition-all duration-300 ease-linear cursor-pointer">
